...
fig = figure
plot(AdjacencyGraph, 'Xdata',xnew,'YData',ynew, 'EdgeColor', Edgec, 'NodeColor',Nodec,'MarkerSize',Nodes.*2, 'LineWidth',Edges )
title(tit, 'FontSize', 20)
set(gca,'ytick',[])
set(gca,'xtick',[])
C = repmat([.175 .54 .60], numcells,1);
for cc = 1:length(Hubby)
C(Hubby(cc),:) = [0.6350, 0.0780, 0.1840];
end
