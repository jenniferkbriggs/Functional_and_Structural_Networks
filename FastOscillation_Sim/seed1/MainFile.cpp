...
getline(infoFile,IcoupInfoLine);
getline(infoFile,ItotInfoLine);
...
Icoupinfo=(char*)IcoupInfoLine.c_str();
Itotinfo=(char*)ItotInfoLine.c_str();
...
puts("Deleted Correctly");
    ...
    if(remove(Noiseinfo)!=0)
       ...
       puts("Deleted Correctly");
if(remove(Icoupinfo)!=0)
perror("Error Deleting File");
else
puts("Deleted Correctly");
if(remove(Itotinfo)!=0)
perror("Error Deleting File");
else
puts("Deleted Correctly");
